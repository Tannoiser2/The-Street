...
def etichetta(regole):
    ...
    if regole.get("tessere_una_volta_per_era") == "true": pezzi.append("tessere una volta per era")
    if regole.get("tessere_una_volta_per_era") == "false": pezzi.append("tessere permanenti")
    ...
    if regole.get("draft_personaggi") == "true": pezzi.append("draft dei Personaggi")
    if regole.get("personaggi_sepolti") == "true": pezzi.append("Personaggi sepolti")
